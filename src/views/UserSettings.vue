  ...
  <div class="user__content">
    <div class="avatar__content">
      <div class="image-wrapper">
        <img v-if="getUserAvatarUrl" :src="getUserAvatarUrl" alt="user photo">
        <span v-else>
      ...
      <div class="editor__content">
        <div class="editor__content-buttons">
          <div class="upload__content">
            Upload photo
            <input type="file" class="upload__avatar">
          </div>
    ...
    <ValidationObserver v-slot="{ handleSubmit }">
      <form @submit.prevent="handleSubmit(submitUserInfo)">
        <ValidationProvider
            name="Имя"
        ...
        >
          ...
          <input v-model="user.firstName" type="text" id="username">
        ...
        >
          ...
          <input v-model="user.phone" type="tel" id="phoneNumber">
          <span class="error__provider">{{ errors[0] }}</span>
        </ValidationProvider>
