    ...
    return (function (document) {
      var doc = (function browserDoc() {
        ...
        const root = Object.assign(document.createElement('div'), {
          ...
          getStyleText() {
            const styles = []
            for (
              let i = 0, rules = this.stylesheet.cssRules, len = rules.length;
              i < len;
              i++
      ...
      return (function mixin(doc) {
        ...
        return Object.assign(
          selfConverter[$.isNode ? 'nodefy' : 'browserify'](
            doc,
            stylesheet,
            opt,
          ),
      ...
      save(opt, props) {
        ...
        return $.Deferred.when(
          ((this.images && Object.keys(this.images)) || []).map(function (a) {
            hasImage = true
            return opt.saveImage(this[a], props).then(url => (images[a] = url))
          }, this.images),
        ).then(() => {
