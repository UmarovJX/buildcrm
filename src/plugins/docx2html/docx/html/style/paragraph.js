...
export default class Paragraph extends Style {
  _getPropertiesConverter(category) {
    ...
    switch (category) {
      case "inline":
        this.inlineStyle = this.doc.createStyle(
          "." + Style.asCssID(this.wordModel.id) + " span"
        );
        return (this[category] = new Inline.Properties(this.inlineStyle));
      case "paragraph":
        this.paragraphStyle = this.doc.createStyle(
          "." + Style.asCssID(this.wordModel.id)
        );
      ...
      case "frame":
        ...
        return (this[category] = new this.constructor.FrameProperties(
          this.paragraphStyle
        ));
      case "numbering":
        this._getPropertiesConverter("paragraph");
