...
class Properties extends Drawing.Properties {
  ...
  _getValidChildren() {
    let t
    const children = super._getValidChildren(...arguments)
  ...
  positionH(x) {
    const o = { relativeFrom: x.attr('relativeFrom') }
    o[x.firstChild.localName] = x.firstChild.localName == 'posOffset'
      ? this.pt2Px(this.asPt(x.firstChild.textContent.trim(), 'cm'))
      : x.firstChild.textContent.trim()
    return o
  }
