<template>
    <div>
        <b-modal id="modal-filter-index" class="py-4" ref="modal" :title="$t('apartments.list.filter')" hide-footer >
                ...
                <div class="container px-0 mx-0">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="">
                                <input class="my-form__input" type="number" v-model="filter.price_from" :placeholder="$t('objects.create.prepay_from')">
                            </div>
                            <div class="mx-2 long-horizontal-line">
                                &#8213;
                            </div>
                            <div class="">
                                <input class="my-form__input" type="number" v-model="filter.price_to" :placeholder="$t('objects.create.prepay_to')">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="">
                                <input v-model="filter.area_from" class="my-form__input" type="number" :placeholder="$t('objects.create.prepay_from')">
                            </div>
                            <div class="mx-2 long-horizontal-line">
                                &#8213;
                            </div>
                            <div class="">
                                <input v-model="filter.area_to" class="my-form__input" type="number" :placeholder="$t('objects.create.prepay_to')">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 my-custom-control">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="custom-control custom-checkbox mr-4" v-for="(object, index) in getObjects" :key="index">
                                <input type="checkbox" class="custom-control-input" v-model="filter.objects" :id="'object' + index" :value="object.id">
                                <label class="custom-control-label" :for="'object' + index">{{ object.name }}</label>
                            </div>
                    ...
                    <div class="mt-4 my-custom-control">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="custom-control custom-checkbox mr-4">
                                <input type="checkbox" class="custom-control-input" id="status" value="1" v-model="filter.status">
                                <label class="custom-control-label" for="status">{{ $t('apartments.filter.free') }}</label>
                            </div>
                        </div>
