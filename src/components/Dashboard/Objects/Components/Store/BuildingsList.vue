        ...
        <div v-for="(building, index) in buildings " :key="index">
            ...
            <div v-else>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="building_name" required v-model="building.name" :placeholder="$t('objects.placeholder.building_name')">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" v-model="building.balcony_price"  min="0" step="0.1" id="balcony_price"  :placeholder="$t('objects.create.balcony_price')">
                </div>

                <button class="btn btn-success"  @click="UpdateBuild(building)" type="button">
                    ...
                    <div>
                        <div class="dropdown my-dropdown dropleft">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item dropdown-item--inside" href="#" @click="building.edit = true" >
...
<!--                                </a>-->
                ...
                <div class="object "><!--mb-5-->
                    <div class="object__item object__item--inside" v-for="(block, block_index) in building.blocks" :key="block_index">
                        <div class="object__more-info">
                            <div class="dropdown my-dropdown dropleft">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <b-link class="dropdown-item dropdown-item--inside" href="#" @click="editBlock(building, block, index, block_index)">
                                        <i class="fas fa-pen"></i> {{ $t('edit') }}
                                    </b-link>
...
<!--                                    </a>-->
        ...
        <create-block :type-plans="plans" @CreateBlockClose="CreateBlockClose" @InsertBlock="InsertBlock" :building="building" :block="block_data" ></create-block>
        <edit-block :type-plans="plans" :building="building"  @SaveEditBlock="SaveEditBlock" :block="block_edit" ></edit-block>
    ...
    export default {
        ...
        methods: {
            async UpdateBuild(building) {
                try {
                    const { data, status } = await this.axios.put(process.env.VUE_APP_URL + '/v2/objects/' + this.object.id  + '/buildings/' + building.id, building, this.header);
            ...
            async CreateBlock(building, index) {
                ...
                try {
                    const { data, status } = await this.axios.post(process.env.VUE_APP_URL + '/v2/objects/buildings/' + building.id + '/block', {}, this.header);
            ...
            DeleteBuild(building, index) {
                this.$swal({
                    ...
                    if (result.value) {
                        this.axios.delete(process.env.VUE_APP_URL + '/v2/objects/' + this.object.id  + '/buildings/' + building.id, this.header).then((response) => {
