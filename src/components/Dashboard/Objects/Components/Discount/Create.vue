                    ...
                    <b-tab :title="$t('objects.create.tariff.fixed')" active>
                        ...
                        <div class="price-block">
                            ...
                            <div class="add-inputs">
                                <div v-for="(deflt,index) in tariff.defaultTariff" :key="`default`+index"
                                        ...
                                        <b-dropdown-text href="#">
                                            <b-form-group v-slot="{ ariaDescribedby }">
                                                <b-form-checkbox-group
                                                    ...
                                                    name="flavour-2"
                                                >
                                                    <b-form-checkbox v-for="option in floors" :key="`default`+option"
                                                                     :value="option">
                                                        {{ option }}
                                                    </b-form-checkbox>
                                                </b-form-checkbox-group>
                        ...
                        <div class="price-block">
                            ...
                            <div class="add-inputs">
                                <div v-for="(other,index) in tariff.otherTariff" :key="`other`+index"
                                     class="add-inputs__row">
                                        ...
                                        <b-dropdown-text href="#">
                                            <b-form-group v-slot="{ ariaDescribedby }">
                                                <b-form-checkbox-group
                                                    ...
                                                    name="flavour-2"
                                                >
                                                    <b-form-checkbox v-for="option in floors" :key="`other`+option"
                                                                     :value="option">
                                                        {{ option }}
                                                    </b-form-checkbox>
                                                </b-form-checkbox-group>
                                    ...
                                    <div class="filter__apartment__price">
                                        ...
                                        >
                                            <base-numeric-input v-model.number="tariff.discount"
                                                                ...
                                                                currency-symbol-position="suffix"
                                                                separator="space"
                                                                :placeholder="$t('objects.create.tariff.add_percent')"
                                                                class="filter__price"
                                                                style="border:none"/>
