        ...
        <base-modal ref="plan-modal" design="auto-height">
            ...
            <template #main>
                <div class="uploader-container flex-column">
                    ...
                    <draggable :list="planData.images" class="row uploader-row ml-0" handle=".handle">
                        <div
                            ...
                            <div class="uploader">
                                <div class="action-list">
                                    <div class="drag-plan handle">
                                        <base-drag-icon :width="20" :height="20" fill="var(--white)"/>
                                    </div>
                                    <div @click="deleteImg(img,index)" class="delete-plan">
                                        <base-delete-icon :width="18" :height="18" fill="var(--white)"/>
                                    </div>
                                </div>
                ...
                <validation-observer tag="form" ref="form" class="create-layout" @submit.prevent="handleSubmit">
                    <ValidationProvider v-for="{label,labelFor,bind,mask,rules,type} in providerSchema"
                        ...
                        <base-input
                            ...
                            :error="!!errors.length"
                            :placeholder="label"
                            :mask="mask" v-model="planData[bind]"/>
                    </ValidationProvider>
                </validation-observer>
            </template>
            ...
            <template #footer>
                <div class="footer-btn">
                    ...
                    <BaseButton @click="add" :fixed="true" design="violet-gradient" :text="$t('add')"/>
                </div>
            </template>
        </base-modal>
    </div>
