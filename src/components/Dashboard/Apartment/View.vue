  ...
  <main>
    <section ref="document" id="printMe">
      ...
      <div class="new-object px-3 px-sm-4 py-4">
          ...
          <div class="row mx-0">
            <div class="col-lg-4 px-0">
              <div class="building">
                ...
                <div class="building__type">
                  {{ $t("apartments.view.plan") }}: {{ getApartment.plan.name }}
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-7 px-0">
              <div class="building__info mt-3">
                <p>
                  {{ $t("apartments.view.number") }}: {{ getApartment.number }}
                </p>
                <p>
        ...
        <div
          class="mt-5 d-flex justify-content-md-start justify-content-center"
        >
          ...
          <div v-if="print">
            ...
            <b-button
              class="my-btn my-btn__blue ml-1"
              v-if="
