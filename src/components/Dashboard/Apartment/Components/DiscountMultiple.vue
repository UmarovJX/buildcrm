<template>
    <div class="apartment">
        ...
        <div class="apartment__variant">
            ...
            <div class="apartment__info" v-if="discount.discount > 0">
                Ежемесячный: <span>{{ apartments[0].object.credit_month }} месяцев {{ getMonth() | number('0,0.00', { 'thousandsSeparator': ' ', 'decimalSeparator': ',' }) }} {{ $t('ye') }} </span>
            </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            getMonth() {
                return (this.getTotal() - this.getPrepay()) / this.apartments[0].object.credit_month;
            },
