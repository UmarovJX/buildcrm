    ...
    async sendForm() {
      ...
      this.$swal({
        ...
        if (result.value) {
          ...
          if (this.apartment.order.id) formData.append('order_id', this.apartment.order.id)
          ...
          api.orders
            .reserveApartment(this.apartment.id, formData)
            .then(response => {
    ...
    >
      ...
      >
        <div class="container px-0 mx-0">
          <div class="row">
            ...
            >
              ...
              >
                <i class="fa fa-calendar" /> Изменить дата договора
              </button>
            ...
            <div
              v-if="!confirm && client.discount.id"
              class="col-md-6"
            >
              <div class="mb-3">
                <label
        ...
        >
          ...
          >
            {{ $t("next") }} <i class="fa fa-chevron-circle-right" />
          </button>
          ...
          <button
            ...
            class="btn btn-success"
          >
            {{ $t("create_agree") }} <i class="fa fa-file-contract" />
          </button>
        </div>
      </form>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <i class="fa fa-chevron-circle-left" /> {{ $t("back") }}
            </button>
