<template>
    <div>
        <b-modal id="modal-view-client" ref="modal" :title="$t('apartments.list.view_client')" hide-footer @show="resetModal">
            ...
            <form ref="form" @submit.stop.prevent="handleSubmit">
                ...
                <b-form-group label-cols="4" label-cols-lg="2" :label="$t('user.phone')" label-for="phone">
                    <b-form-input id="phone" disabled v-model="getReserveClient.phone"></b-form-input>
                </b-form-group>
