...
<template>
  <div>
    ...
    <div v-if="listPermission" class="payments__history">
      ...
      <base-modal design="payment-modal" ref="payment-addition-modal">
        <template #header>
          <!--   GO BACK     -->
    ...
    <div class="payment__schedule">
      <div>
        <h3 class="title">
          {{ $t("payment_schedule") }} ({{ monthlyPaymentsCount }}
          {{ $t("month") }}.)
        </h3>
    ...
    <!-- WARNING MODAL -->
    <base-modal design="small-modal" ref="initial-payment-warning">
      <template #header>
