...
<template>
  <div class="logs-content">
    ...
    <div class="accordion-list">
      <div
        v-for="(activity, index) in daysList"
        :key="index"
        class="accordion"
        role="tablist"
      >
        ...
        >
          ...
          >
            <b-card-body>
              ...
              <div
                v-if="item.properties.old || item.properties.attributes"
                class="header-data"
              >
                <div
                  :class="
                ...
                >
                  ...
                  />
                  <output-information
                    v-if="item.properties.old.date_paid"
                    :value="item.properties.old.date_paid"
                    property="Label"
                  />
                  <output-information
                    v-if="item.properties.old.payment_type"
                ...
                >
                  ...
                  />
                  <output-information
                    v-if="item.properties.attributes.date_paid"
                    :value="item.properties.attributes.date_paid"
                    property="Label"
                  />
                  <output-information
                    v-if="item.properties.attributes.payment_type"
                    :value="item.properties.attributes.payment_type"
                    property="Label"
                  />
                  <output-information
                    v-if="item.properties.attributes.status"
                    :value="item.properties.attributes.status"
                    property="Label"
                  />
                  <output-information
                    v-if="item.properties.attributes.type"
