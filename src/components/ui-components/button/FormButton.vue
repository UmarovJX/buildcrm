<template>
    ...
    >
        ...
        <x-icon v-else-if="leftIcon && !loading && !rightIcon"
                :name="leftIcon"
        ...
        <div v-if="loading" class="loading-item">
            <div class="loading__content">
                <div class="loading__content-main">
...
export default {
    ...
    props: {
        ...
        variant: p(PROP_TYPE_STRING, 'primary'),
    ...
    computed: {
        ...
        renderClass() {
            return [this.variant, {'disabled': this.disabled}, {'loading': this.loading}, {'fixed': this.fixed}]
        }
    },
    methods: {
        triggerEvent() {
