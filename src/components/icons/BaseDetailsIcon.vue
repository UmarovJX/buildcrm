<template>
  <svg :width="width" :height="height" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10.33 16.5929H4.0293" :stroke="fill" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M13.1406 6.90036H19.4413" :stroke="fill" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
