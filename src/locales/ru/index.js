export default {
    ...
    roles_permission: {
        ...
        apartments: {
            watch_apartments: 'Право просмотра списка квартир (страница одного объекта)',
            filter_apartments: 'Право пользования фильтром на странице списка квартир',
            edit_apartment: 'Право редактировать квартиру (страница одного объекта)',
            status_apartment: 'Право снять с продажи и вернуть в продажу квартиру (страница одного объекта)',
            change_list_apartments: 'Право пользования списком для изменения вида списка квартир',
            list_apartments1: 'Право пользования шахматкой 1.0 для изменения вида списка квартир',
            list_apartments2: 'Право пользования шахматкой 2.0 для изменения вида списка квартир',
            using_layouts: 'Право пользования планировкой для изменения вида списка квартир',
            comments_view: "Право на просмотр комментариев",
            comments_create: "Право на создание комментария",
            comments_edit: "Право на редактирование комментария",
            comments_delete: "Право на удаление комментария",
        },
        execution: {
        ...
        contracts: {
            ...
            reissue_view: 'Право на пресмотр переоформление',
    ...
    leave_import_text: "Вы уверены, что хотите отменить и выйти из импорта? </br>" +
    ...
    payments: {
        ...
        table: {
            date: 'Дата', balance: 'Сумма', type: 'Тип', method: 'Способ', comment: 'Комментарий', actions: 'Действия',
        }
    },
    ...
    contracts: {
        ...
        view: {
            regenerate_warning: 'Контракт может быть переоформлен только один раз. Уточните всю информацию, прежде чем продолжить',
    ...
    roles: {
        ...
        permissions: {
            ...
            type_plan: {
                view: "Разрешить видеть планировок", update: "Разрешить редактировать планировки",
            },
    ...
    sweetAlert: {
        ...
        are_you_sure_delete_role: "Если удалите роль вы должны назначить новый роль для пользователей текущей роли", // 'text_cancel_contract': 'Вы действительно хотите расторгнуть контракт',
        ...
        debtors: {
            ...
            next: "Продолжить",
            are_you_sure: "Вы точно хотите подтвердить оплату? Потом невозможно отменить!",
    ...
    accountants: {
        title: "Бухгалтерия", role_title: "Бухгалтерия",
    },
