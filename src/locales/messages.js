export default {
    ru: {
        ...
        clients: {
            ...
            language: "Язык",
            date: "Дата",
            search: "Найти по номеру договора или по номеру телефона клиента",
        },
    ...
    uz: {
        ...
        sweetAlert: {
            ...
            are_you_sure_delete_role:
                "Agar rolni o'chirmoqchi bo'lsangiz bu ro'ldagi foydalanuvchilar uchun yangi rol tanlashingiz kerak!",
            // 'text_cancel_contract': 'Вы действительно хотите расторгнуть контракт',
