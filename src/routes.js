...
import CheckoutV2 from '@/views/checkoutV3/Index'
...
import TabWarnings from '@/components/Contracts/view/TabWarnings'
    ...
    children: [
...

      {
        ...
        children: [
          ...
          {
            name: 'contract-warnings',
            path: 'contract-warnings',
            component: TabWarnings,
            meta: {
              requiresAuth: 'contracts',
            },
          },
      ...
      },
      {
        path: 'roles/create',
        name: 'role-v2-create',
        component: () => import('@/views/rolesV2/RoleUpsert.vue'),
      },
      {
        path: 'roles/:id/edit',
        name: 'role-v2-edit',
