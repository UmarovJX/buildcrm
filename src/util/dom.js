...
export const matchesEl = ELEMENT_PROTO.matches
  || ELEMENT_PROTO.msMatchesSelector
  || ELEMENT_PROTO.webkitMatchesSelector

// See: https://developer.mozilla.org/en-US/docs/Web/API/Element/closest
/* istanbul ignore next */
export const closestEl = ELEMENT_PROTO.closest
  || function (sel) {
    let el = this
    do {
...
export const MutationObs = WINDOW.MutationObserver
...
export const getTabables = (rootEl = document) => selectAll(TABABLE_SELECTOR, rootEl)
  .filter(isVisible)
