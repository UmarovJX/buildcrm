...
export const datesEqual = (date1, date2) =>
  ...
  formatYMD(date1) === formatYMD(date2)
...
export const oneYearAgo = date => addYears(date, -1)

export const oneYearAhead = date => addYears(date, 1)

export const oneDecadeAgo = date => addYears(date, -10)

export const oneDecadeAhead = date => addYears(date, 10)
