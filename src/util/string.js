...
import {
  isArray, isPlainObject, isString, isUndefinedOrNull,
} from './inspect'

// --- Utilities ---

// Converts PascalCase or camelCase to kebab-case
export const kebabCase = str => str.replace(RX_HYPHENATE, '-$1').toLowerCase()
...
export const toString = (val, spaces = 2) => (isUndefinedOrNull(val)
  ? ''
  : isArray(val)
